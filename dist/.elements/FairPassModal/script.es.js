...
class FairPassSimpleEmail001 extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$2, create_fragment$2, safe_not_equal, { href: 7, fpScope: 8, step: 0, open: 6 });
  }
}
var global = "";
...
function create_fragment(ctx) {
  let fairpassmodal;
  let current;
  const fairpassmodal_spread_levels = [ctx[0]];
  let fairpassmodal_props = {};
  for (let i = 0; i < fairpassmodal_spread_levels.length; i += 1) {
    fairpassmodal_props = assign(fairpassmodal_props, fairpassmodal_spread_levels[i]);
  }
  fairpassmodal = new FairPassModal({ props: fairpassmodal_props });
  return {
    c() {
    ...
    p(ctx2, [dirty]) {
      const fairpassmodal_changes = dirty & 1 ? get_spread_update(fairpassmodal_spread_levels, [get_spread_object(ctx2[0])]) : {};
      fairpassmodal.$set(fairpassmodal_changes);
    },
    i(local) {
      if (current)
        return;
...
class FairPassModal_1 extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, create_fragment, safe_not_equal, {});
  }
}
export { FairPassModal_1 as default };
